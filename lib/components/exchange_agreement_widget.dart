            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Text(
                    '1. 기프티콘 등록 전 사용 여부를 꼭 확인해주세요!\n기프티콘의 사용 여부는 검수 시에 기프티카노가 확인할 수 없어요. 사용 여부는 고객님께서 확인해주셔야 한답니다. (이미 기프티콘이 아메리카노로 교환된 후에 사용 완료/사용 중인 기프티콘이라는 점이 확인되면 기프티콘의 가격에 상응하는 포인트 차감 혹은 환불을 요청드릴 수 있습니다.)\n\n2. 등록된 기프티콘은 검수를 거치게 돼요!\n기프티콘이 검수에 통과하면 자동으로 등록하신 기프티콘을 아메리카노로 바꿔드려요. (최대 24시간 소요)\n\n2. 4500원 이상의 기프티콘만 등록하실 수 있어요! \n\n3. 다음과 같은 기프티콘은 검수에서 반려될 수 있습니다!\n- 유효기간이 짧거나 누락된 기프티콘\n- 이미지 해상도가 낮은 기프티콘\n- 사용 가능한 매장이 정해진 경우\n- 사용 시 본인 인증이 필요한 기프티콘',
